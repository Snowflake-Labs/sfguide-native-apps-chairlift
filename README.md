...
Once the references have been declared in the application manifest, consumers can grant the privilege to `EXECUTE TASK` to the application by clicking the `Request Privileges` button.
